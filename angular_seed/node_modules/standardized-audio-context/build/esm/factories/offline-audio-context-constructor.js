...
export var createOfflineAudioContextConstructor = function (baseAudioContextConstructor, createInvalidStateError, nativeOfflineAudioContextConstructor, startRendering) {
    return /** @class */ (function (_super) {
        ...
        OfflineAudioContext.prototype._waitForThePromiseToSettle = function (event) {
            var _this = this;
            if (this._state === null) {
