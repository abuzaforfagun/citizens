...
export var createMinimalAudioContextConstructor = function (createInvalidStateError, minimalBaseAudioContextConstructor, nativeAudioContextConstructor) {
    return /** @class */ (function (_super) {
        tslib_1.__extends(MinimalAudioContext, _super);
        function MinimalAudioContext(options) {
        ...
        Object.defineProperty(MinimalAudioContext.prototype, "state", {
            get: function () {
        ...
        MinimalAudioContext.prototype.close = function () {
            var _this = this;
        ...
        MinimalAudioContext.prototype.resume = function () {
            return this._nativeAudioContext
                .resume()
                .catch(function (err) {
        ...
        MinimalAudioContext.prototype.suspend = function () {
            return this._nativeAudioContext
                .suspend()
                .catch(function (err) {
                // Bug #56: Safari invokes the catch handler but without an error.
...
//# sourceMappingURL=/build/es2015/factories/minimal-audio-context-constructor.js.map