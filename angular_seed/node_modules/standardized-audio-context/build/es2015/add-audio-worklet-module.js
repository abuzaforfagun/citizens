...
export const addAudioWorkletModule = (context, moduleURL, options = { credentials: 'omit' }) => {
    ...
    if (nativeContext.audioWorklet !== undefined) {
        ...
        const promise = fetch(moduleURL)
            ...
            .then((source) => {
            const fn = new Function('AudioWorkletProcessor', 'currentFrame', 'currentTime', 'global', 'registerProcessor', 'sampleRate', 'self', 'window', source);
            ...
            fn(class AudioWorkletProcessor {
