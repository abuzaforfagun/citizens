...
export const createNativeConstantSourceNodeFactory = (createNativeConstantSourceNodeFaker) => {
    return (nativeContext, options) => {
        ...
        if (!cacheTestResult(testConstantSourceNodeAccurateSchedulingSupport, () => testConstantSourceNodeAccurateSchedulingSupport(nativeContext))) {
