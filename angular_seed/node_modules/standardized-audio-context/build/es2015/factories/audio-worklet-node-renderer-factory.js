...
const processBuffer = (proxy, renderedBuffer, nativeOfflineAudioContext, options, processorDefinition) => tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    const parameters = Array
        ...
        return Object.assign({}, prmtrs, { [name]: renderedBuffer.getChannelData(numberOfInputChannels + index) });
    }, {});
        ...
        return {
            render: (proxy, nativeOfflineAudioContext) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                if (nativeAudioWorkletNodeConstructor === null) {
                    ...
                    const constantSourceNodes = yield Promise
                        .all(Array
                        .from(proxy.parameters.values())
                        .map((audioParam) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                        ...
                        yield renderAutomation(proxy.context, partialOfflineAudioContext, audioParam, constantSourceNode.offset);
                    ...
                    return Promise
                        ...
                        .then((renderedBuffer) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                        ...
                        const processedBuffer = yield processBuffer(proxy, renderedBuffer, nativeOfflineAudioContext, options, processorDefinition);
                        if (processedBuffer !== null) {
                ...
                if (!isOwnedByContext(nativeAudioNode, nativeOfflineAudioContext)) {
                    ...
                    for (const [nm, audioParam] of Array.from(proxy.parameters.entries())) {
                        yield renderAutomation(proxy.context, nativeOfflineAudioContext, audioParam, nativeAudioNode.parameters.get(nm));
                    }
                }
                else {
                    // @todo Using Array.from() is a lazy fix that should not be necessary forever.
                    for (const [nm, audioParam] of Array.from(proxy.parameters.entries())) {
                        yield connectAudioParam(proxy.context, nativeOfflineAudioContext, audioParam, nativeAudioNode.parameters.get(nm));
                    }
                }
