...
export const createNativeAudioWorkletNodeFakerFactory = (connectMultipleOutputs, createIndexSizeError, createInvalidStateError, createNativeChannelMergerNode, createNativeChannelSplitterNode, createNativeConstantSourceNode, createNativeGainNode, createNotSupportedError, disconnectMultipleOutputs) => {
    return (nativeAudioContext, processorDefinition, options) => {
        ...
        const scriptProcessorNode = nativeAudioContext.createScriptProcessor(bufferSize, numberOfInputChannels + numberOfParameters, 
        ...
        const parameterMap = new ReadOnlyMap(processorDefinition.parameterDescriptors
            .map(({ name }, index) => {
        ...
        const parameters = processorDefinition.parameterDescriptors
