...
const isSupportingPromises = (nativeOfflineAudioContext) => cacheTestResult(testPromiseSupport, () => testPromiseSupport(nativeOfflineAudioContext));
export const createMinimalOfflineAudioContextConstructor = (createInvalidStateError, minimalBaseAudioContextConstructor, nativeOfflineAudioContextConstructor, startRendering) => {
